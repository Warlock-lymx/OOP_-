...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			String remoteHome = "D:\\homework\\src\\com\\huawei\\classroom\\student\\h62\\test\\";
			...
			config.setPort(9999);
			// 存放了用户名 口令 的认证数据文件
			config.setPasswordFile("D:\\homework\\src\\com\\huawei\\classroom\\student\\h62\\my_user.txt");
			// 构造我的监听类
