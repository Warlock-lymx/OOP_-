...
public class Test {
	...
	public static void main(String[] args) {
		...
		Map<String, Integer> map = vote.calcRecording(
				"D:\\homework\\src\\com\\huawei\\classroom\\student\\h58\\vote_detail.txt");
				//"xxxx/vote_detail.txt");
		
		System.out.println(map);
		System.out.println(System.currentTimeMillis()-l+ " ms cost!");
		if((Math.abs(map.get("wang")-3358)/3358<=0.2)&&(Math.abs(map.get("zhao")-6664)/6664<=0.2)&&(Math.abs(map.get("li")-3189)/3189<=0.2)) {
