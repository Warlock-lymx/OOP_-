...
public class Test {
	...
	public static void main(String[] args) {
		...
		try {
			...
			BattleField.init("D:\\homework\\src\\com\\huawei\\classroom\\student\\h17\\rules.ini");
			...
			for (int i = 0; i < gameObjects.size(); i++) {
				...
				System.out.print(gameObject.player.name + "." + gameObject.getClass().getName());
				System.out.print(" live=" + !gameObject.isDestroyed() + " x=" + gameObject.x + " y=" + gameObject.y + " health=" + gameObject.getHealth());
				System.out.println();
			}
